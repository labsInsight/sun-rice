<template>
  <div class="group">
    ...
    <div class="block">
      ...
      <s-tabs v-model="active1" swipeable>
        <s-tab :title="'标签' + index" v-for="index in tabs" :key="index">
    ...
    <div class="block">
      ...
      <s-tab-scroll :titles="['保障计划', '投保方案', '产品介绍']" v-model="active0" @change="tabChange">
        <template slot="page0">
    ...
    <div class="block">
      ...
      <s-tabs>
        <s-tab v-for="index in 8" :title="'标签' + index" :key="index">
          <div class="page">页面内容：{{ index }}</div>
        </s-tab>
      </s-tabs>
    </div>
    ...
    <div class="block">
      ...
      <s-tabs type="card">
        <s-tab v-for="index in 4" :title="'标签' + index" :key="index">
          <div class="page">页面内容：{{ index }}</div>
        </s-tab>
      </s-tabs>
    </div>
    ...
    <div class="block">
      ...
      <s-tabs :active="active" @click="onClick">
        <s-tab v-for="index in 2" :key="index">
          <div slot="title">
